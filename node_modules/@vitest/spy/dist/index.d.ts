...
interface PartialMock<T extends Procedure | Constructable = Procedure> extends Mock<PartialResultFunction<T extends Mock ? NonNullable<ReturnType<T["getMockImplementation"]>> : T>> {}
